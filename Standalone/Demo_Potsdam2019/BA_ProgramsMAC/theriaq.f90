...
!
 ...
 1045 FORMAT (' saturation pressure = ',F10.3)
...
!----
 ...
 1005 FORMAT (/ &
      ...
      'chemical potential of charge =',0PF15.4/ &
...
!----
      ...
      NEEF,IJY,HIT(50),ICH,GEBRAU(1000)
...
!-----
 ...
 3031 FORMAT (A16,2X,'this is a aq.species')
      NAEF=NAEF+1
      I2=NBEF+NAEF
      CALL INSERT(NCOL,I2)
      GOTO 655
...
!-----
 ...
 3032 FORMAT (A16,2X,'this is a mineral')
      NMEF=NMEF+1
      I2=NBEF+NAEF+NMEF
      CALL INSERT(NCOL,I2)
      GOTO 655
...
!-----
 ...
 3033 FORMAT (A16,2X,'this is a element')
      NEEF=NEEF+1
      END IF
  655 CONTINUE
!-----
...
!+++++
      ...
      CALL MATPRT
      WRITE (6,1000) NBEF,NAEF,NMEF,NEEF,NCOL
...
!++++++++++++++++++++++++++++++++++++++
 ...
 1500 FORMAT ('EQ3NR Input file name = data0.cdc'/ &
      'direct pipeline fron THERIAQ'/'endit.')
      WRITE (17,1501) TC
 ...
 1510 FORMAT ('endit.')
!++++++++++++++++++++++++++++++++++++++
      WRITE (16,2000) BLOCKC,BLOCKC
 2000 FORMAT ('data0.com.R10'/'THERMODYNAMIC DATABASE'/  &
      'generated by THERIAQ'/A70/'data0 parameters'/A70)
!     WRITE (16,2001) TC,TC
...
!-----
 ...
 2005 FORMAT ('debye huckel b (adh)'/5X,4F10.4/5X,4F10.4)
!-----
