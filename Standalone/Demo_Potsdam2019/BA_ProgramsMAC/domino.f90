...
! pwave_solids      'vpsol'     -         -      -1000   0    -6     1
! swave_solids      'vssol'     -         -      -1000   0    -7     1
! shearm_solids     'musol'     -         -      -1000   0    -8     1
! Ks_solids         'kssol'     -         -      -1000   0    -9     1
!
!----- here FUNTAXI
...
!      VNEED=.FALSE.
      ...
      END IF
      !-- eduester18
      IF (VERGL(SONAM,'vpsol')) THEN
      I0=-1000
      I2=-6
      GOTO 593
      END IF
      IF (VERGL(SONAM,'vssol')) THEN
      I0=-1000
      I2=-7
      GOTO 593
      END IF
      IF (VERGL(SONAM,'musol')) THEN
      I0=-1000
      I2=-8
      GOTO 593
      END IF
      IF (VERGL(SONAM,'kssol')) THEN
      I0=-1000
      I2=-9
      GOTO 593
      END IF
...
!*****
      ...
      !-- eduester18
      IF (MAPEM.EQ.-6) XMAP(MAPANZ)=PPVELO
      IF (MAPEM.EQ.-7) XMAP(MAPANZ)=SSVELO
      IF (MAPEM.EQ.-8) XMAP(MAPANZ)=((WTSOL/F001)*SSVELO**(2.0D0))/100000.0D0
      IF (MAPEM.EQ.-9) XMAP(MAPANZ)=(PPVELO*PPVELO*(WTSOL/F001)-(4.0D0/3.0D0) &
      *(WTSOL/F001)*SSVELO**(2.0D0))/100000.0D0
      !--
